defmodule Mix.Tasks.Dino.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.
      mix dino.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  the CLI.
      ...
      # Via CLI
      mix dino.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ## Attributes
  The resource fields are given using `name:type` syntax
  where type are the types supported by Ecto. Omitting
  the type makes it default to `:string`:
      mix dino.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      mix dino.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      mix dino.gen.schema Blog.Post blog_posts tags:array:string
  Unique columns can be automatically generated by using:
      mix dino.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique
  If no data type is given, it defaults to a string.
  ## table
  By default, the table name for the migration and schema will be
  the plural name provided for the resource. To customize this value,
  a `--table` option may be provided. For example:
      mix dino.gen.schema Blog.Post posts --table cms_posts
  ## binary_id
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix dino.gen.schema must be invoked from within your *_web application root directory"
    end
  ...
  @doc false
  def files_to_be_generated(%Schema{file: file}) do
    file = file |> String.split("/") |> List.insert_at(-2, "schema") |> Enum.join("/")
    [{:eex, "schema.ex", file}]
  end
  ...
  def copy_new_files(%Schema{context_app: ctx_app} = schema, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/dino.gen.schema", binding, files)
    ...
    if schema.migration? do
      ...
      Mix.Phoenix.copy_from paths, "priv/templates/dino.gen.schema", binding, [
  ...
  def raise_with_help(msg) do
    Mix.raise """
    #{msg}
    mix dino.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:
        mix dino.gen.schema Blog.Post blog_posts title:string
    """
  end
