defmodule Mix.Tasks.Dino.Gen.Live do
  ...
  defp files_to_be_generated(%Context{name: name, schema: schema, context_app: context_app}) do
  ...
  defp copy_new_files(%Context{} = context, binding, paths) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/dino.gen.live", binding, files)
  ...
  defp maybe_inject_helpers(%Context{context_app: ctx_app} = context) do
    ...
    inject = "import #{inspect(context.web_module)}.Live.Helpers"
  ...
  defp do_inject_helpers(context, file, file_path, inject) do
    ...
    if file != new_file do
      ...
      and that both functions import #{inspect(context.web_module)}.Live.Helpers.
      """
    end
  end
