defmodule DinoTasksWeb.Live.Layout.Header do
  @moduledoc """
  Header
  """
  use DinoTasksWeb, :live_component
        ...
        <div class="px-8 py-4">
          <nav class="relative flex items-center justify-between sm:h-10">
            ...
            <div class="hidden md:block md:ml-10 md:pr-4">
              <%= live_redirect "Home", to: Routes.live_path(@socket, DinoTasksWeb.Live.Home), class: "font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-900 focus:outline-none focus:text-gray-900" %>
              ...
              <%= live_redirect "Weather Example", to: Routes.live_path(@socket, DinoTasksWeb.Live.WeatherExample), class: "ml-8 font-medium text-indigo-600 transition duration-150 ease-in-out hover:text-indigo-900 focus:outline-none focus:text-indigo-700" %>
            </div>
          </nav>
        </div>
          ...
          <div class="rounded-lg shadow-md">
            <div class="bg-gray-200 rounded-lg shadow-xs">
              ...
              <div class="flex flex-col px-2 pt-2 pb-3">
                <%= live_redirect "Home", to: Routes.live_path(@socket, DinoTasksWeb.Live.Home), class: "mt-2 font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-900 focus:outline-none focus:text-gray-900" %>
                ...
                <%= live_redirect "Weather Example", to: Routes.live_path(@socket, DinoTasksWeb.Live.WeatherExample), class: "mt-2 pb-1 font-medium text-indigo-600 transition duration-150 ease-in-out hover:text-indigo-900 focus:outline-none focus:text-indigo-700" %>
              </div>
            </div>
          </div>
        </div>
