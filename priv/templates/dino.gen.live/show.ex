defmodule <%= inspect context.web_module %>.<%= inspect Module.concat(Live, context.name) %>.<%= inspect Module.concat(schema.web_namespace, schema.alias) %>.Show do
  @moduledoc """
          ...
          <div class="flex justify-between">
            ...
            <nav class="flex">
              ...
              <%%= live_redirect "Back",
                ...
                class: "ml-2 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-green-700 bg-green-100 hover:bg-green-50 focus:outline-none focus:border-green-300 focus:shadow-outline-green active:bg-green-200 transition ease-in-out duration-150" %>
            </nav>
          </div>
